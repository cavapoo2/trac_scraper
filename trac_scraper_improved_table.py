...
async def scrape_trac_ticket(url: str, output_dir: str = "ticket_data", headless: bool = True):
    ...
    async with async_playwright() as p:
        ...
        async def extract_fields_from_row(row):
            """Extract field-value pairs from a table row, skipping form elements."""
            fields = {}
            try:
                    ...
                    try:
                        ...
                        if current_tag == "th":
                            ...
                            if i + 1 < len(children):
                                ...
                                if next_tag == "td":
                                    # IMPORTANT: Check if this td contains form elements
                                    # If it does, it's the "Change Properties" section, not the display section
                                    ...
                                    is_form_cell = has_select or has_input or has_textarea
                                    
                                    if not is_form_cell:
                                        # This is a display cell, not a form cell - extract it!
                                        ...
                                        print(f"    Skipping form cell for: {header_clean}")
